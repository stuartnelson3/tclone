...
(function() {
  ...
  $(document).on("keyup", "#tweet_text", function(e) {
    var $char_count, $create_tweet, characters_remaining;
    ...
    return $char_count.text(characters_remaining);
  });
  ...
  $(document).on("click", ".favorite", function(e) {
    ...
    params = {
      ...
      success: function() {
        return $(_this).removeClass("favorite btn-primary").addClass("unfavorite btn-danger").text("Unfavorite");
      }
    };
    return $.ajax(params);
  });
  ...
  $(document).on("click", ".unfavorite", function(e) {
    ...
    params = {
      ...
      success: function() {
        return $(_this).addClass("favorite btn-primary").removeClass("unfavorite btn-danger").text("Favorite");
      }
    };
    return $.ajax(params);
  });
  ...
  $(document).on("click", ".follow", function(e) {
    ...
    params = {
      ...
      success: function() {
        return $(_this).removeClass("follow btn-primary").addClass("unfollow btn-danger").text("Unfollow");
      }
    };
    return $.ajax(params);
  });
  ...
  $(document).on("click", ".unfollow", function(e) {
    ...
    params = {
      ...
      success: function() {
        return $(_this).addClass("follow btn-primary").removeClass("unfollow btn-danger").text("Follow");
      }
    };
    return $.ajax(params);
  });
